...
ICE=/Developer/SDKs/IceTouch-1.0/iphoneos.sdk/usr/local
CC=/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/arm-apple-darwin9-gcc-4.0.1
CPP=/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/arm-apple-darwin9-g++-4.0.1
STD=/Developer/Platforms/iPhoneOS.platform/Developer/usr/lib/gcc/arm-apple-darwin9/4.0.1
LD=$(CC)
...
CFLAGS += -I"$(ICE)/include"
CFLAGS += -I"$(STD)/include"
CFLAGS += -I"./Classes"
